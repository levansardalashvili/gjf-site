    ...
    <>
      ...
      <main className="max-w-[1400px] mx-auto px-5">
        <div className="pt-10 pb-7">
          <div className="text-sm opacity-50 mb-3.5"><Trans k="home_bc" /> / <Trans k="calendar" /></div>
          <h1 className="font-serif font-bold text-3xl md:text-4xl"><Trans k="calendar" /></h1>
        </div>
