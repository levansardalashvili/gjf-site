      ...
      <main className="max-w-[1400px] mx-auto px-5">
        <div className="pt-10 pb-8">
          <div className="text-sm opacity-50 mb-3.5">
            <a href="/federation" className="hover:text-gold"><Trans k="federation" /></a> / <Trans k="committee" />
          </div>
          <h1 className="font-serif font-bold text-3xl md:text-4xl"><Trans k="committee" /></h1>
        </div>
