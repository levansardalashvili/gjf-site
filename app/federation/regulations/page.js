      ...
      <main className="max-w-[1400px] mx-auto px-5">
        <div className="pt-10 pb-8">
          <div className="text-sm opacity-50 mb-3.5">
            <a href="/federation" className="hover:text-gold">ფედერაცია</a> / დებულებები
          </div>
          <h1 className="font-serif font-bold text-3xl md:text-4xl">დებულებები</h1>
        </div>
        ...
        {regulations.length === 0 && <p className="opacity-50 text-sm pb-16">დებულება ჯერ არ არის დამატებული.</p>}
      </main>
      <Footer />
    </>
  );
