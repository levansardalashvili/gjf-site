...
export default function StaffForm({ initial, id }) {
  ...
  async function handleSubmit(e) {
    ...
    setSaving(true);
    setError("");
    const endpoint = isEdit ? `/api/staff/${id}` : "/api/staff";
  ...
  return (
    <form onSubmit={handleSubmit} className="max-w-xl flex flex-col gap-4">
      ...
      <div>
        <label className="block text-xs uppercase tracking-wide opacity-55 mb-1.5">თანამდებობა</label>
