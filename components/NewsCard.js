...
export default function NewsCard({ slug, date, title, title_en, medal, image_url, created_at }) {
  ...
  return (
    ...
    >
      ...
      <div className="p-4 pb-5 flex flex-col flex-1">
        ...
        <h3 className="font-sans font-semibold leading-snug text-base line-clamp-2">{displayTitle}</h3>
