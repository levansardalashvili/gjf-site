...
const LINKS = [
  { href: "/teams/staff", titleKey: "coachingStaff" },
  { href: "/teams/standart", titleKey: "mensTeam" },
  { href: "/teams/women", titleKey: "womensTeam" },
];
  ...
  return (
    <div className="w-full py-16">
      <div className="max-w-[1400px] mx-auto px-5">
        <h2 className="font-serif font-bold text-2xl mb-6">{t("nationalTeam")}</h2>
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          {LINKS.map((l) => (
            ...
            >
              <span className="font-semibold">{t(l.titleKey)}</span>
